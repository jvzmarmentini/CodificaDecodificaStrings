...
public class App {
    ...
    public static void main(String args[]) {
        ...
        String palavraOriginal = "JoãoGabriel";
        String palavraCodificada = codificador.codifica(palavraOriginal);
        String palavraDecodificada = codificador.decodifica(palavraCodificada);
